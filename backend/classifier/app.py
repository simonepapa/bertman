...
def get_data():
    ...
    minmaxScaler = request.args.get('minmaxScaler', default='true')
    ...
    geojson_data = analyze_quartieri(articles_df, quartieri_df, geojson_data, crimes, weightsForArticles, weightsForPeople, minmaxScaler)
